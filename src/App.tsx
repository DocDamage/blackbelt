...
import { BeltPage } from './pages/belts/BeltPage';
...
function ToolContentPage({ tool, content }: { tool: string; content: React.ReactNode }) {
    return (
...
function App() {
    ...
    return (
        <UserProvider>
            <div className="app-layout" role="application" aria-label="Six Sigma Training Platform">
                ...
                <main id="main-content" className="main-content" role="main" tabIndex={-1}>
                    <ErrorBoundary>
                        <Routes>
                            ...
                            {/* Belt Levels */}
                            <Route path="/belts/white" element={<BeltPage belt="white" onProgressUpdate={loadProgress} />} />
                            <Route path="/belts/white/:moduleId" element={<BeltPage belt="white" onProgressUpdate={loadProgress} />} />
                            <Route path="/belts/yellow" element={<BeltPage belt="yellow" onProgressUpdate={loadProgress} />} />
                            <Route path="/belts/yellow/:moduleId" element={<BeltPage belt="yellow" onProgressUpdate={loadProgress} />} />
                            <Route path="/belts/green" element={<BeltPage belt="green" onProgressUpdate={loadProgress} />} />
                            <Route path="/belts/green/:moduleId" element={<BeltPage belt="green" onProgressUpdate={loadProgress} />} />
                            <Route path="/belts/black" element={<BeltPage belt="black" onProgressUpdate={loadProgress} />} />
                            <Route path="/belts/black/:moduleId" element={<BeltPage belt="black" onProgressUpdate={loadProgress} />} />
                            <Route path="/belts/master" element={<BeltPage belt="master" onProgressUpdate={loadProgress} />} />
                            <Route path="/belts/master/:moduleId" element={<BeltPage belt="master" onProgressUpdate={loadProgress} />} />

                            {/* Tools */}
                            <Route path="/tools" element={<ToolsCalculatorPage />} />
                            <Route path="/tools/control-charts" element={
                                <ToolContentPage tool="📊 Control Charts" content={
                                    <div>
                            ...
                            <Route path="/tools/capability" element={
                                <ToolContentPage tool="📐 Capability Calculator" content={
                                    <div>
                            ...
                            <Route path="/tools/fishbone" element={
                                <ToolContentPage tool="🐟 Fishbone Diagram (Ishikawa)" content={
                                    <div>
                            ...
                            <Route path="/tools/doe" element={
                                <ToolContentPage tool="🔬 DOE Planner" content={
                                    <div>
